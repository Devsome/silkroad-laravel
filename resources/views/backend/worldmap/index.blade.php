                                ...
                                <div class="form-group" id="search">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control"
                                               placeholder="{{ __('backend/worldmap.search-placeholder') }}"
                                               name="player">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#">Zones</a>
                                            <ul>
                                                ...
                                                <li><a href="#map" onclick="xSROMap.SetView(-12378,-1344)">Storm and
                                                        Cloud Desert</a>
                                                </li>
                                        ...
                                        <li><a href="#">Areas</a>
                                            <ul>
                                                <li><a href="#">Donwhang Stone Cave</a>
                                                    <ul>
                                                        <li><a href="#map" onclick="xSROMap.SetView(0,0,0,32769)">Donwhang
                                                                Dungeon B1 (Lv.61~64)</a>
                                                        </li>
                                                        <li><a href="#map" onclick="xSROMap.SetView(0,0,115,32769)">Donwhang
                                                                Dungeon B2 (Lv.64~66)</a>
                                                        </li>
                                                        <li><a href="#map" onclick="xSROMap.SetView(0,0,230,32769)">Donwhang
                                                                Dungeon B3 (Lv.65~68)</a>
                                                        </li>
                                                        <li><a href="#map" onclick="xSROMap.SetView(0,0,345,32769)">Donwhang
                                                ...
                                                <li><a href="#">Tomb of Qui-Shin</a>
                                                    <ul>
                                                        <li><a href="#map" onclick="xSROMap.SetView(0,0,0,32775)">Qin-Shi
                                                                Tomb B1 (Lv.81~85)</a>
                                                        </li>
                                                        <li><a href="#map" onclick="xSROMap.SetView(0,0,0,32774)">Qin-Shi
                                                                Tomb B2 (Lv.86~90)</a>
                                                        </li>
                                                        <li><a href="#map" onclick="xSROMap.SetView(0,0,0,32773)">Qin-Shi
                                                                Tomb B3 (Lv.90~95)</a>
                                                        </li>
                                                        <li><a href="#map" onclick="xSROMap.SetView(0,0,0,32772)">Qin-Shi
                                                                Tomb B4 (Lv.96~99)</a>
                                                        </li>
                                                        <li><a href="#map" onclick="xSROMap.SetView(0,0,0,32771)">Qin-Shi
                                                                Tomb B5</a>
                                                        </li>
                                                        <li><a href="#map" onclick="xSROMap.SetView(0,0,0,32770)">Qin-Shi
                                                                Tomb B6</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li><a href="#map" onclick="xSROMap.SetView(0,0,0,32785)">Cave of
                                                        Meditation</a>
                                                </li>
                                            </ul>
                                        </li>
