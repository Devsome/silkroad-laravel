...
class JobRankingDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->editColumn('DT_RowIndex', function ($data = '$query') {
                return ++$this->count;
            })
            ...
            ->editColumn('type', function ($data = '$query') {
                if ($data->JobType == 1) {
                    return __('ranking.table.trader');
                } else if ($data->JobType == 3) {
                    return __('ranking.table.hunter');
                } else {
                    return __('ranking.table.thief');
                }
            })
